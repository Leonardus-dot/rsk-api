...
if ($method == 'POST') {
	...
	echo "\n"; 
	echo "  <link rel=\"icon\" type=\"image/png\" href=\"hhttp://app.rssekarkamulyan.com:8081/api-rsk/img/logo-rsk.png\">\n";
	echo "    <link href=\"http://app.rssekarkamulyan.com:8081/api-rsk/css/bootstrap.min.css\" rel=\"stylesheet\">\n"; 
	echo "    <link href=\"http://app.rssekarkamulyan.com:8081/api-rsk/css/style.css\" rel=\"stylesheet\">\n"; 
	echo "\n"; 
	echo "  </head>\n"; 
	...
	echo "				<h4>\n"; 
	echo "					Pemberitahuan !\n"; 
	echo "				</h4>Informasi username & Password, Silahkan email ke sisfo@rssekarkamulyan.com !<i> <a href=\"http://rssekarkamulyan.com\" class=\"alert-link\">Kunjungi Web</a></i>\n"; 
	echo "			</div>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:8081/api-rsk/token\">http://app.rssekarkamulyan.com:8081/api-rsk/token</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:8081/api-rsk/get-antrean\">http://app.rssekarkamulyan.com:8081/api-rsk/get-antrean</a>\n"; 
	echo "						</td>\n";
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 	
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:8081/api-rsk/rekap-antrean\">http://app.rssekarkamulyan.com:8081/api-rsk/rekap-antrean</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:8081/api-rsk/jadwal-operasi\">http://app.rssekarkamulyan.com:8081/api-rsk/jadwal-operasi</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:8081/api-rsk/get-operasi\">http://app.rssekarkamulyan.com:8081/api-rsk/get-operasi</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:8081/api-rsk/batal-antrean\">http://app.rssekarkamulyan.com:8081/api-rsk/batal-antrean</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:8081/api-rsk/cekin-antrean\">http://app.rssekarkamulyan.com/:8081/api-rsk/cekin-antrean</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:8081/api-rsk/sisa-antrean\">http://app.rssekarkamulyan.com:8081/api-rsk/sisa-antrean</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:8081/api-rsk/status-antrean\">http://app.rssekarkamulyan.com:8081/api-rsk/status-antrean</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:8081/api-rsk/pasien-baru\">http://app.rssekarkamulyan.com:8081/api-rsk/pasien-baru</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
