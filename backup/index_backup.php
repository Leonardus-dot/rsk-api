...
if ($method == 'POST') {
	...
	echo "\n"; 
	echo "  <link rel=\"icon\" type=\"image/png\" href=\"hhttp://app.rssekarkamulyan.com:7777/api-rsk/img/logo-rsk.png\">\n";
	echo "    <link href=\"http://app.rssekarkamulyan.com:7777/api-rsk/css/bootstrap.min.css\" rel=\"stylesheet\">\n"; 
	echo "    <link href=\"http://app.rssekarkamulyan.com:7777/api-rsk/css/style.css\" rel=\"stylesheet\">\n"; 
	echo "\n"; 
	echo "  </head>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:7777/api-rsk/rest/token\">http://app.rssekarkamulyan.com:7777/api-rsk/rest/token</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:7777/api-rsk/rest/get-antrean\">http://app.rssekarkamulyan.com:7777/api-rsk/rest/get-antrean</a>\n"; 
	echo "						</td>\n";
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 	
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:7777/api-rsk/rest/rekap-antrean\">http://app.rssekarkamulyan.com:7777/api-rsk/rest/rekap-antrean</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:7777/api-rsk/rest/jadwal-operasi\">http://app.rssekarkamulyan.com:7777/api-rsk/rest/jadwal-operasi</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:7777/api-rsk/rest/get-operasi\">http://app.rssekarkamulyan.com:7777/api-rsk/rest/get-operasi</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"http://app.rssekarkamulyan.com:7777/api-rsk/rest/batal-antrean\">http://app.rssekarkamulyan.com:7777/api-rsk/rest/batal-antrean</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"https://api-rsk.rssekarkamulyan.com/rest/cekin-antrean\">https://api-rsk.rssekarkamulyan.com/rest/cekin-antrean</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
	...
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							<a href=\"https://api-rsk.rssekarkamulyan.com/rest/pasien-baru\">https://api-rsk.rssekarkamulyan.com/rest/pasien-baru</a>\n"; 
	echo "						</td>\n"; 
	echo "						<td>\n"; 
	echo "							POST\n"; 
	echo "						</td>\n"; 
