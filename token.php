...
if ($method == 'GET') {
	...
	$response = array();
			...
			if (($header['x-username'] == $username) && ($header['x-password'] == $password)){
					$response = array(
						'response' => array(
							'token' => $RSKauth
						),
			...
			else if (($header['x-username'] == null) && ($header['x-password'] == null)){
					$response = array(
                    'status' => array(
			...
			else if (!($header['x-username']) && (!$header['x-password'])){
					$response = array(
                    'status' => array(
